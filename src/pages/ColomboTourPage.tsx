...
export const ColomboTourPage: React.FC = () => {
  const { navigateTo } = useNavigation();
  const tour = toursData.find((t) => t.id === 'colombo-city-tour') || toursData[1];

  return (
    <article id="colombo-tour-page" className="py-6 sm:py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav aria-label="Breadcrumb" className="mb-6">
          <ol className="flex items-center gap-2 text-xs text-stone-500">
            ...
            <li>/</li>
            <li className="font-semibold text-stone-900 truncate">Colombo City Tour</li>
          </ol>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12 items-start">
          <div className="lg:col-span-7">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-100 text-amber-900 text-xs font-bold uppercase tracking-wider mb-3">
              ...
              <span>Capital Highlights & Street Food Safari</span>
            </div>

            <h1 className="font-heading font-extrabold text-3xl sm:text-5xl text-stone-900 tracking-tight leading-tight mb-4">
              Colombo City Highlights & Street Food TukTuk Safari
            </h1>

            <p className="text-base sm:text-lg text-stone-600 leading-relaxed mb-6">
              Experience the energetic contrast of Sri Lanka's capital. Zip through the narrow spice corridors of Pettah, photograph the legendary Red Mosque, marvel at sacred Buddhist relics at Gangaramaya, and taste freshly fried isso vade by the crashing surf of Galle Face Green.
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs sm:text-sm mb-6">
              ...
              <div className="bg-white p-3 rounded-xl border border-stone-200/80 col-span-2 sm:col-span-1">
                <span className="text-stone-400 block text-[11px] font-semibold">Tasting</span>
                <span className="font-bold text-stone-900 flex items-center gap-1.5 mt-0.5">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                id="colombo-book-whatsapp-btn"
                href={getWhatsAppUrl(
                  "Hello! I am interested in the Colombo City Highlights & Street Food TukTuk Tour. Could you please send pricing and pickup details?"
                )}
                target="_blank"
          ...
          <div className="lg:col-span-5 space-y-3">
            <div className="rounded-2xl overflow-hidden shadow-lg border border-stone-200 aspect-[4/3] bg-stone-100">
              <img
                src={tour.heroImage}
                alt="Colombo TukTuk sightseeing safari"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5">
            <div id="colombo-inquiry-form" className="sticky top-24">
              <div className="bg-amber-50 rounded-2xl p-4 border border-amber-200 mb-4 text-xs text-amber-900">
                <span className="font-bold block mb-1">Pickup Anywhere in Negombo or Colombo</span>
                We can start from your hotel in Negombo or directly from your Colombo accommodation or cruise terminal.
              </div>
              <InquiryForm
                initialTourId={tour.id}
                compact={true}
                formType="Colombo City Tour Page Booking"
              />
            </div>
          </div>
        </div>
